...
| **Vote sum match (dd=0)** | 387 / 387 (100%) | 380 / 385 (98.7%) |
...
|  | สส.เขต (Constituency) | บัญชีรายชื่อ (Party List) |
|---|---|---|
| **คะแนนรวม (total votes)** | 33,838,547 | 33,827,457 |
...
| ภูมิใจไทย | 5,971,237 |
| เพื่อไทย | 5,365,697 |
| ประชาธิปัตย์ | 3,905,610 |
| เศรษฐกิจ | 1,104,400 |
| **รวมทุกพรรค (385 เขต)** | **33,827,941** |
...
│   ├── party_list.csv              # ผลแบบบัญชีรายชื่อ ทุกพรรค (21,943 rows)
...
เทียบ 3,372 ผู้สมัคร สส.เขตกับ DB → UUID ตรง 100%, เลขหมายตรง 100%
...
- **5 เขต บัญชีรายชื่อ dd≠0** — เป็นข้อจำกัดของ OCR จาก PDF สแกนคุณภาพต่ำ ไม่สามารถแก้เพิ่มได้
